...
#* @param NPK201226available =  FALSE
#* @param NPK201226CostperBag = NA
#* @param NPK201226BagWt = 50
...
getRecommendation <- function(country = c("NG", "TZ"),
                              ...
                              userField,
                              riskAtt = c(0, 1, 2),
                              NPK201226available = c(TRUE, FALSE), NPK201226CostperBag = NA, NPK201226BagWt = 50,
                              ...
                              newFert5name = c(TRUE, FALSE), newFert5N_cont = NA, newFert5P2O5 = NA, newFert5K2O = NA, newFert5CostperBag = NA, newFert5BagWt = NA)
{
  ...
  print("Starting up release candidate script")
  ...
  #@Bug
  #FCY of 11 causes failure errors saying object harvestDate not found
  #FCY <- 25
  print(paste("Area units is", areaUnits))
  print(paste("Harvest date is ", HD))
  print(paste("Planting date is ", PD))
  ...
  if (email == TRUE) {
    ...
    tryCatch({
      sendEmailReport(userEmail = userEmail,
                      FR = FR,
                      IC = IC,
                      PP = PP,
                      SP = SP,
