...
#* @json
#* @post /api/v2/dst/recommendation/ng
nigeriaRec <- function(country = c("NG", "TZ"),
lat,
lon,
area,
...
newFert5name = c(TRUE, FALSE), newFert5N_cont = NA, newFert5P2O5 = NA, newFert5K2O = NA, newFert5CostperBag = NA, newFert5BagWt = NA)
{
    ...
    #placeholder until we figure out how to deal with out of bounds coordinates properly
    # lat = 8.725;
    # lon = 4.025;



    # These values are for future use for nowe we will just pass NA until further notice
    ...
    # SMS = email = FALSE; userPhoneCC = 254; userPhoneNr = 702974480; userName = "Meklit"; userEmail = "akilimo@gmail.com"; userField = "Runda field"

    # myTimestamp <- Sys.time()

    print(paste("Begining computation from BE release candidate script at",Sys.time()))
    ...
    if(IC == TRUE)                        {res[["IC"]] <- getICrecommendations(areaHa = areaHa,
    CMP = CMP,
    cobUP = cobUP,
    fertilizers = fertilizers,
    riskAtt = riskAtt)
    ...
    #  if(email == TRUE)                       {sendEmailReport(userEmail=userEmail, FR=FR, IC=IC, PP=PP, SP=SP)}
...
#* @param newFert5BagWt=NA
#* @json
#* @post /api/v2/dst/recommendation/tz
tzRec <- function(country = c("NG", "TZ"),
lat,
lon,
area,
areaUnits = c("acre", "ha", "m2"),
...
newFert5name = c(TRUE, FALSE), newFert5N_cont = NA, newFert5P2O5 = NA, newFert5K2O = NA, newFert5CostperBag = NA, newFert5BagWt = NA)
{
    print("Set default parmeters for tanzania")


    ureaavailable = TRUE; ureaCostperBag = "NA"; ureaBagWt = 50; MOPavailable = FALSE; MOPCostperBag = "NA"; MOPBagWt = 50;
    DAPavailable = TRUE; DAPCostperBag = "NA"; DAPBagWt = 50; NPK201010available = FALSE; NPK201010CostperBag = "NA"; NPK201010BagWt =50;
    NPK151515available = FALSE; NPK151515CostperBag = "NA"; NPK151515BagWt =50;TSPavailable = FALSE; TSPCostperBag = "NA"; TSPBagWt = 50;
    NPK171717available = FALSE; NPK171717CostperBag = "NA"; NPK171717BagWt = 50; Nafakaavailable = FALSE; NafakaCostperBag = "NA"; NafakaBagWt = 50;
    CANavailable = FALSE; CANCostperBag = "NA"; CANBagWt = 50; SSPavailable = FALSE; SSPCostperBag = "NA"; SSPBagWt = 50; country="TZ";
    newFert1name="YaraMila_UNIK"; newFert1N_cont=0.17; newFert1P2O5=2.59; newFert1K2O=4.882; newFert1CostperBag=61000; newFert1BagWt=50;
    newFert2name="NA"; newFert2N_cont="NA"; newFert2P2O5="NA"; newFert2K2O="NA"; newFert2CostperBag="NA"; newFert2BagWt="NA";
    newFert3name="NA"; newFert3N_cont="NA"; newFert3P2O5="NA"; newFert3K2O="NA"; newFert3CostperBag="NA"; newFert3BagWt="NA";
    newFert4name="NA"; newFert4N_cont="NA"; newFert4P2O5="NA"; newFert4K2O="NA"; newFert4CostperBag="NA"; newFert4BagWt="NA";
    newFert5name="NA"; newFert5N_cont="NA"; newFert5P2O5="NA"; newFert5K2O="NA"; newFert5CostperBag="NA"; newFert5BagWt="NA"
    ...
    lat = -7.725; lon = 37.875;

    PD = "2018-01-03"
    HD = "2019-01-03"

    country = "TZ";  maxInv = 450000
    ...
    FCY = 11.25 ## HD = number of days on the field
    area = 1; areaUnits = "ha"; saleSF = TRUE; nameSF = "PsaltryMarketers"; cassPD = "roots"
    cassUW = 1000;
    ploughing = TRUE; ridging = TRUE
    method_ploughing = method_ridging = "manual"
    CMP = 3; riskAtt = 1; PD_window = 1; HD_window = 1;
    ...
    FR = TRUE
    intercrop <- FALSE
    SMS = email = TRUE; userPhoneCC = 254; userPhoneNr = 702974480; userName = "Akilimo farmer"; userEmail = "akilimo@gmail.com"; userField = "Runda field"

    print("Finished setting default parameters for tZ")
