...
{
  print(paste("Starting plumbR version 2 script. processing",country))
  ...
  if (email == TRUE) {
    ...
    tryCatch({
      ...
      print(paste("Warning occured while sending email: ", w))
    }, error = function(e) {
      print(paste("Error occured while sending email: ", e))
    })
  }

  print(paste("Returning recommendations back akilimo API... for country", country))
