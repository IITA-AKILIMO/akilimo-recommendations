...
#' @note:   Wrapper function to calculate recommendations across all use cases.
...
getRecommendation <- function(country = c("NG", "TZ"),
 ...
 # setwd("/home/akilimo/projects/akilimo_recommendation/ScriptPackage")
  source("AkilimoFunctions_dev.R")
	...
	fertilizers <-  fertilizerFunc(ureaavailable=ureaavailable, ureaCostperBag=ureaCostperBag,ureaBagWt=ureaBagWt,
			...
			NPK201226available= NPK201226available, NPK201226CostperBag =NPK201226CostperBag, NPK201226BagWt=NPK201226BagWt,
